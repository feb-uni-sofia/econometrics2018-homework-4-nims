...
# high school with 1 percent is observed with an estimated increase of crime rate of 1.48%
## b)
crime2 <- crime[,-1]
pairs( ~ ., data = crime2)
...
# between the two variables HS and U. There is multicolinearity, meaning one feature
